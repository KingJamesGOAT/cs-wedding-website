...
const INITIAL_GIFTS: GiftItem[] = [
  ...
  { id: 'c6', category: 'kitchen', title: { en: 'Set of 6 Wine Glasses', fr: 'Ensemble de 6 verres à vin' }, price: 15, collected: 0, icon: Wine },
  { id: 'c7', category: 'kitchen', title: { en: 'Water Pitcher', fr: 'Pichet à eau' }, price: 10, collected: 0, icon: Coffee },
  { id: 'c8', category: 'kitchen', title: { en: '30-Piece Cutlery Set', fr: 'Ensemble de 30 couverts' }, price: 40, collected: 0, icon: Utensils },
  { id: 'c9', category: 'kitchen', title: { en: 'Set of 6 Cups & Saucers', fr: 'Ensemble 6 tasses + soucoupes' }, price: 25, collected: 0, icon: Coffee },
  { id: 'c10', category: 'kitchen', title: { en: 'Set of 8 Bowls', fr: 'Ensemble de 8 bols' }, price: 20, collected: 0, icon: Utensils },
  { id: 'c11', category: 'kitchen', title: { en: '2 Cutting Boards', fr: '2 Planches à découper' }, price: 35, collected: 0, icon: Utensils },
  { id: 'c12', category: 'kitchen', title: { en: '3 Carving Knives', fr: '3 Couteaux à découper' }, price: 50, collected: 0, icon: Utensils },
  { id: 'c13', category: 'kitchen', title: { en: 'Colander', fr: 'Passoire' }, price: 20, collected: 0, icon: Utensils },
  { id: 'c14', category: 'kitchen', title: { en: 'Glass Salad Bowl', fr: 'Saladier en verre' }, price: 10, collected: 0, icon: Utensils },
  { id: 'c15', category: 'kitchen', title: { en: 'Salad Servers', fr: 'Couverts à salade' }, price: 20, collected: 0, icon: Utensils },
  { id: 'c16', category: 'kitchen', title: { en: 'Ladles, Spatulas & Spoons Set', fr: 'Ensemble louches-spatules-et-cuilleres' }, price: 20, collected: 0, icon: Utensils },
  { id: 'c17', category: 'kitchen', title: { en: 'Teapot', fr: 'Théière' }, price: 25, collected: 0, icon: Coffee },
  { id: 'c18', category: 'kitchen', title: { en: 'Toaster', fr: 'Grille-pain' }, price: 30, collected: 0, icon: Zap },
